                    ...
                    <div class=" w-col col-lg-4">
                        <div class="vertical-align">
                            ...
                            @else
                                ...
                                <a style="margin:1em;" href="{{ route('frontend.homepage') }}" class="button-white orange w-button" data-translate-text="EXPLORE">{{ __('web.BECOME_A_MEMBER') }}</a>
                                <a style="margin:1em;" class="button-white orange w-button create-account" data-translate-text="BECOME_A_MEMBER">{{ __('web.BECOME_A_MEMBER') }}</a>
                            @endif
                        </div>
                    </div>
                    <div class="claim-column-right col">
                        <img src="{{ asset('skins/default/images/main-landing.png') }}" alt="{{ __('web.LANDING_TITLE') }}" class="claim-landing-image">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="card-info w-col col-lg-4 col-12">
                        <div class="position-relative d-flex justify-content-center mb-3">
                            <img  style="width: 70%; max-height: 100%;" src="{{ asset('skins/default/images/landing-collection.svg') }}" alt="" class="card-image">
                        </div>
                    ...
                    <div class="card-info w-col col-lg-4 col-12">
                        <div class="position-relative d-flex justify-content-center mb-3">
                            <img  style="width: 70%; max-height: 100%;" src="{{ asset('skins/default/images/landing-pocket.svg') }}" alt="" class="card-image">
                        </div>
                    ...
                    <div class="card-info w-col col-lg-4 col-12">
                        <div class="position-relative d-flex justify-content-center mb-3">
                            <img style="width: 70%; max-height: 100%;" src="{{ asset('skins/default/images/landing-foryou.svg') }}" alt="" class="card-image">
                        </div>
...
<!--                <h2 class="claim-h2-white padding-bottom-40px text-white" data-translate-text="CLAIM_NOW_TEXT">{{ __('web.CLAIM_NOW_TEXT') }}</h2>
                ...
                <div class="d-flex justify-content-center">
                    ...
                    <a class="button-white orange w-button create-account" data-translate-text="BECOME_A_MEMBER">{{ __('web.BECOME_A_MEMBER') }}</a>
                </div>
            </div>
        </div>
