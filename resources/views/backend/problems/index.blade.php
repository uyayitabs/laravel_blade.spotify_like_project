                            ...
                            @if($report->object)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @elseif($report->reportable_type === 'App\\Models\\Comment')
                                            <a href="{{ route('backend.comments.edit', ['id' => $report->reportable_id]) }}">{{ $report->object->commentable->title ?? null }}</a>
                                        @else
                                            <a href="{{ route('backend.' . strtolower(str_replace('App\\Models\\', '', $report->reportable_type)) . 's.edit', ['id' => $report->object->id]) }}">{{ $report->object->title ?? null }}</a>
                                        @endif
                                    </td>
                                    ...
                                    <td class="desktop">
                                        @if($report->reportable_type === 'App\\Models\\Comment')
                                            <a href="{{ $report->object->commentable->permalink_url ?? null }}" class="btn btn-sm btn-info" target="_blank">Preview</a>
                                        @else
                                            <a href="{{ $report->object->permalink_url ?? null }}" class="btn btn-sm btn-info" target="_blank">Preview</a>
                                        @endif
                                    </td>
                                    <td>
