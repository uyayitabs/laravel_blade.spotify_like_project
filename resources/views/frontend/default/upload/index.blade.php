                    ...
                    <form id="fileupload" data-template="template-upload" method="POST" enctype="multipart/form-data">
                        <div class="upload-container">
                            ...
                            <div id="upload-file-button" class="btn btn-primary">
                                ...
                                <input id="upload-file-input" type="file" accept="audio/basic,audio/mid,audio/mpeg,audio/x-aiff,audio/x-mpegurl,audio/x-pn-realaudio,audio/x-wav,audio/*" name="file" multiple>
                            </div>
                        </div>
                    </form>
                </div>
