                    ...
                    @if(isset( $request->user))
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="row-button delete" data-toggle="tooltip" data-placement="top" title="Reject this request, an email will be automatically sent to the author." onclick="return confirm('Are you sure want to reject this request?');" href="{{ route('backend.artist.access.reject', ['id' => $request->id]) }}"><i class="fas fa-eject"></i></a>
                            </td>
                        </tr>
                    @endif
                @endforeach
