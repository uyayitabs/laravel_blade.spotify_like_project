...
class SearchController
{
    ...
    public function generalSearch()
    {
        ...
        $songs = Song::whereRaw('title like ?', $searchTerm)->limit(5)->get();
        $artists = Artist::whereRaw('name like ?', $searchTerm)->limit(5)->get();
        $playlists = Playlist::whereRaw('title like ?', $searchTerm)->limit(5)->get();
        $albums = Album::whereRaw('title like ?', $searchTerm)->limit(5)->get();
        $podcasts = Podcast::with('artist')->whereRaw('title like ?', $searchTerm)->limit(5)->get();
    ...
    public function song()
    {
        ...
        if (isset($songs) && count($songs)) {
            ...
            $result->songs = Song::whereRaw('title like ?', ['%' . $this->term . '%'])->paginate(20);
        }
    ...
    public function artist()
    {
        ...
        if (isset($artists) && count($artists)) {
            ...
            $result->artists = Artist::whereRaw('name like ?', ['%' . $this->term . '%'])->paginate($this->limit);
        }
    ...
    {
        $result = (object) array();
        $result->lyricists = Lyricist::whereRaw('name like ?', ['%' . $this->term . '%'])->paginate($this->limit);
    ...
    public function album()
    {
        ...
        if (isset($albums) && count($albums)) {
            ...
            $result->albums = Album::whereRaw('title like ?', ['%' . $this->term . '%'])->paginate($this->limit);
        }
    ...
    public function playlist()
    {
        ...
        if (isset($playlists) && count($playlists)) {
            ...
            $result->playlists = Playlist::whereRaw('title like ?', ['%' . $this->term . '%'])->paginate($this->limit);
        }
    ...
    public function station()
    {
        ...
        $result->stations = Station::whereRaw('title like ?', ['%' . $this->term . '%'])->paginate($this->limit);
    ...
    public function podcast()
    {
        ...
        if (isset($podcasts) && count($podcasts)) {
            ...
            $result->podcasts = Podcast::with('artist')->whereRaw('title like ?', ['%' . $this->term . '%'])->paginate($this->limit);
        }
    ...
    {
        $searchTerm = ['%' . $this->term . '%'];
        $songs = Song::whereRaw('title like ?', $searchTerm)->limit($this->limit)->get();
        $artists = Artist::whereRaw('name like ?', $searchTerm)->limit($this->limit)->get();
        $albums = Album::whereRaw('title like ?', $searchTerm)->limit($this->limit)->get();
        $playlists = Playlist::with('user')->whereRaw('title like ?', $searchTerm)->limit($this->limit)->get();
        $stations = Station::whereRaw('title like ?', $searchTerm)->limit($this->limit)->get();
        $users = User::whereRaw('name like ?', $searchTerm)->limit($this->limit)->get();
    ...
    {
        $cities = City::whereRaw('name like ?', ['%' . $this->term . '%'])->paginate(20);
    ...
    public function video()
    {
        ...
        $result->videos = \App\Models\Video::whereRaw('title like ?', ['%' . $this->term . '%'])->paginate(20);
        ...
        $searchTerm = ['%' . $this->term . '%'];
        $result->playlists = Playlist::whereRaw('title like ?', $searchTerm)->paginate($this->limit);
        $result->artists = Artist::whereRaw('name like ?', $searchTerm)->paginate($this->limit);
        $result->albums = Album::whereRaw('title like ?', $searchTerm)->paginate($this->limit);
        $result->playlists = Playlist::whereRaw('title like ?', $searchTerm)->paginate($this->limit);
        $result->users = User::whereRaw('name like ?', $searchTerm)->paginate($this->limit);
        $result->events = Event::whereRaw('title like ?', $searchTerm)->paginate($this->limit);
