...
Route::post('auth/signup_artist', 'AuthController@signupArtist')->name('auth.signup_artist');
Route::post('auth/login', 'AuthController@login')->name('auth.login');
Route::get('connect/redirect/{service}/{originUrl?}', 'AuthController@socialiteLogin')->name('auth.login.socialite.redirect');
