        ...
        <div class="lbcontainer">
            <div id="claimArtistLightbox">
                ...
                <ul id="lightbox-stages-header" class="">
                    ...
                    <li class="lightbox-stage active" rel="info">
                        <div class="circle">
                ...
                <div class="lightbox-content">
                    ...
                    <div class="lightbox-content-block">
                        <div id="artist-claiming-stage-account" class="claiming-stage hide">
                            <p data-translate-text="VERIFY_ACCOUNT_EMAIL_MESSAGE">{{ __('web.VERIFY_ACCOUNT_EMAIL_MESSAGE') }}</p>
                            <div class="control-group floated">
                                <label class="control-label" for="artist-claiming-email" data-translate-text="FORM_EMAIL_ADDRESS">{{ __('web.FORM_EMAIL_ADDRESS') }}</label>
                                <div class="control"><input type="text" id="artist-claiming-email" value=""></div>
                            </div>
                            <div class="control-group floated">
                                <label class="control-label" for="artist-claiming-fname" data-translate-text="FORM_FULL_NAME">{{ __('web.FORM_FULL_NAME') }}</label>
                                <div class="control"><input type="text" id="artist-claiming-fname" value=""></div>
                            </div>
                            <div class="control-group password-container hide">
                                <label class="control-label" for="artist-claiming-password" data-translate-text="FORM_PASSWORD_REQUIRED">>{{ __('web.FORM_PASSWORD_REQUIRED') }}</label>
                                <div class="control"><input type="password" id="artist-claiming-password"></div>
                            </div>
                        </div>
                       <div id="artist-claiming-stage-info" class="claiming-stage">
                            ...
                            <div class="control-group">
                                <div class="control">
                                    <label class="control-label" for="artist-claiming-phone" data-translate-text="FORM_PHONE">{{ __('web.FORM_PHONE') }}</label>
                                    <input type="text" id="artist-claiming-phone" value="">
                                </div>
                                <div class="control">
                                    <label class="control-label" for="artist-claiming-phone-ext" data-translate-text="FORM_PHONE_EXT">{{ __('web.FORM_PHONE_EXT') }}</label>
                                    <input type="text" id="artist-claiming-phone-ext" value="">
                                </div>
                                <div class="control"><label class="control-label" for="artist-claiming-affiliation" data-translate-text="FORM_ARTIST_AFFILIATION">{{ __('web.FORM_ARTIST_AFFILIATION') }}</label>
                                    <select id="artist-claiming-affiliation" class="span2">
                                        ...
                                        <option value="Artist/Band Member" selected>{{ __('web.ARTIST_AFFILIATION_1') }}</option>
                           ...
                           {{--<div class="message-container">
                                <label class="control-label" for="artist-claiming-message" data-translate-text="EXPLAIN_ARTIST_IDENTITY">{{ __('web.EXPLAIN_ARTIST_IDENTITY') }}</label>
                       ...
                       <div class="connect-container">
                           <input class="hide custom-checkbox" id="accept-terms" type="checkbox" name="accept-terms" checked="checked">
           ...
           <div class="lightbox-footer">
               <div class="right">
                   {{--<a class="btn btn-primary continue" data-translate-text="CONTINUE">{{ __('web.CONTINUE') }}</a>--}}
                        <a class="btn btn-primary continue" data-translate-text="CREATE_ARTIST_PROFILE">{{ __('web.CREATE_ARTIST_PROFILE') }}</a>
    ...
    <div class="lightbox lightbox-signup hide">
        <div class="lbcontainer">
            <form id="singup-form" method="POST" action="{{ route('frontend.auth.info.validate') }}">
                <div class="lightbox-header">
                    <h2 class="title" data-translate-text="POPUP_SIGNUP_LISTENER_TITLE">{{ __('web.POPUP_SIGNUP_LISTENER_TITLE') }}</h2>
                    @yield('lightbox-close')
                </div>
                <div class="lightbox-content">
                    <div class="lightbox-error error hide"></div>
...
{{--                            </div>--}}
    ...
    <div class="lightbox-sm lightbox-signup-select hide">
        <div class="lbcontainer">
            <div class="lightbox-header">
            ...
            <div class="lightbox-content">
                <a href="{{ route('frontend.signup_artist') }}" class="btn btn-primary submit signup-as-artist" data-translate-text="IM_AN_ARTIST_BTN">{{ __('web.IM_AN_ARTIST_BTN') }}</a>
                <a class="btn btn-secondary signup-as-listener" data-translate-text="IM_A_LISTENER_BTN">{{ __('web.IM_A_LISTENER_BTN') }}</a>
            </div>
        </div>
    </div>
                    ...
                    <div class="tab-content">
                        @if(config('settings.payment_stripe'))
                            <div class="control-group tab-pane fade" id="stripe-payment" role="tabpanel" aria-labelledby="stripe-payment-tab">
                                ...
                                @php $formUrl = auth()->check() && auth()->user()->id == 229 ? route('frontend.stripe.subscription.callback.v2') : route('frontend.stripe.subscription.callback') @endphp
                                <form id="stripe-form" class="ajax-form stripe-local-form" method="post" action="{{ $formUrl }}">
                        ...
                        <div class="lightbox-content-block">
                            ...
                            <div class="song-info-container">
                                ...
                                <div class="control field">
                                    ...
                                    <input name="isrccode" type="text" placeholder="ISRC Code" autocomplete="off">
                                </div>
