...
class CommentsController
{
    ...
    public function reply()
    {
        ...
        $comment = Comment::withoutGlobalScopes()->where('id', $this->request->input('parent_id'))->firstOrFail();
    ...
    public function getReplies()
    {
        ...
        $per_page = 5;
        $query = Comment::withoutGlobalScopes()
            ->with('user')
    ...
    public function getComments()
    {
        ...
        $comments = Comment::withoutGlobalScopes()
            ...
            ->whereNull('parent_id')
            ->whereBetween('created_at', [now()->subMonths(1)->startOfDay()->toDateTimeString(), now()->endOfDay()->toDateTimeString()])
    ...
    public function deleteComment()
    {
        ...
        $comment = Comment::withoutGlobalScopes()
