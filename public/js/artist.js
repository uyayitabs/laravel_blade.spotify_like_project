(function (factory) {
    ...
    window.Artist = {
        ...
        claim: {
            ...
            qInput: $(".lightbox-claimArtist input[name=q]"),
            artistNameInput: $(".lightbox-claimArtist input[name=artist_name]"),
            ...
            init: function (el) {
                ...
                Artist.claim.qInput.val(User.userInfo.name);
                Artist.claim.artistNameInput.val(User.userInfo.name);
            ...
            show: {
                ...
                information: function () {
                    // Commented to proceed in the POST request to artistClaim POST request
                    // $('.lightbox-stage').removeClass('active');
            ...
            information: function () {
                ...
                fd.append('fullName', Artist.claim.fullNameInput.val() !== Artist.claim.qInput.val() ? Artist.claim.qInput.val() : Artist.claim.fullNameInput.val());
                ...
                fd.append('artist_name', Artist.claim.fullNameInput.val() !== Artist.claim.qInput.val() ? Artist.claim.qInput.val() : Artist.claim.fullNameInput.val());
    ...
    $(document).ready(function () {
        Artist.claim.continueButton.bind('click', Artist.claim.information);
