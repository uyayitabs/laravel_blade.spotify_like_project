...
@section('content')
    <div class="get-verify-now">
       ...
       <div class="container claim-container mt-5 desktop">
        ...
        <div class="va-section-footer mt-5" style="background-color: #2A9D8F;">
            <div class="container">
                ...
                <div class="d-flex justify-content-center">
                    <a class="button-white w-button claim-artist-access orange" data-translate-text="CLAIM_NOW_BUTTON_TEXT">{{ __('web.CLAIM_NOW_BUTTON_TEXT') }}</a>
                </div>
            </div>
        </div>
    </div>
